!netcdf_write writes out arrays into netcdf format.
...
subroutine netcdf_write_on_fault(outfile)
	...
	lat_units = 'unit'
	lon_units = 'unit'
	var_name = [ character(len=20) :: 'shear_strike', 'shear_dip', 'effective_normal', 'slip_rate' ]
	var_unit = [ character(len=20) :: 'Pa'          , 'Pa'       , 'Pa'              , 'm/s'       ]
