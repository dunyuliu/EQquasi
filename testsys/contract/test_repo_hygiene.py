...
def test_e2e_runs_stay_under_the_scratch_root():
    ...
    """
    bench = read("testsys/e2e/test_benchmarks.py")
    ...
    assert "shutil.rmtree(workdir" in read("testsys/e2e/cases.py"), \
...
def test_no_dead_aztec_sources_in_src():
    ...
    model.txt, which is a positional contract with script/case.setup. Dropping
