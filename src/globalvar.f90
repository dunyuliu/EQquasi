MODULE globalvar
    ...
    real (kind = dp)     :: dtev, dtev1
        real (kind = dp)     :: totMomRate, totMomRateVW,           maxSlipRate,            totRuptArea,&
                                totTaoRuptArea,                     totSlipRuptArea
        real (kind = dp)     :: tdynastart, tdynaend,   tcheck,     t_end_status,           t_start_status
    ...
    integer (kind = 4)   :: C_elastic,  C_Nuclea,   friclaw,    rough_fault,            bp,         &
                                ...
                                nstep,            dis4uniF,   dis4uniB,   C_farfield = 0
