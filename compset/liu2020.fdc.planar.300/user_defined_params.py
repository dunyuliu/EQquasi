#! /usr/bin/env python3
# compset: liu2020.fdc.planar.300
...
par.fxmin, par.fxmax = -30e3, 30e3
par.fymin, par.fymax = -30e3, 30e3
par.fzmin, par.fzmax = -30e3, 0
...
par.xminc, par.xmaxc, par.zminc = -25e3, 25e3, -25e3

par.dx = 300.0e0 # cell size, spatial resolution
par.dy = par.dx
par.dz = par.dx
par.nuni_y_plus, par.nuni_y_minus = 10, 10 # along the fault-normal dimension, the number of cells share the par.dx cell size.
...
par.init_norm = -50.0e6 # initial normal stress in Pa. Negative compressive.
...
# par.xi, minimum Dc
par.xi              = 0.02 # par.xi used to limit variable time step size. See Lapusta et al. (2009).
...
####################################
par.casename       = "liu2020-planar-quasi"
