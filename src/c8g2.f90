...
subroutine c8g2(elemx,material,es,em,ef,Vol)
    ...
    real (kind=dp) :: gl(3,3,8),elemx(3,8)
    real (kind=dp) :: shl(3,8,8),shg(3,8,8)!nrowsh*nen*nint
    real (kind=dp) :: shl0(8,8),w(8)
    real (kind=dp) :: coef(3,3,8),jacob(8),B(6,24),DD(24,6)
    real (kind=dp) :: es(24,24),em(24),ef(24)
    real (kind=dp) :: material(5),vp,vs,rou,D0(6,6),Vol
