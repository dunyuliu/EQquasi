...
xminc, xmaxc, zminc = -400, 400, -400

dx = 10.0e0 # cell size, spatial resolution
nuni_y_plus, nuni_y_minus = 5, 5 # along the fault-normal dimension, the number of cells share the dx cell size.
enlarging_ratio = 1.0 # along the fault-normal dimension (y), cell size will be enlarged at this ratio compoundly.
...
for ix in len(stXRange):
    for iy in len(stYRange):
        for iz in len(stZRange):
            ...
            nTag = nTag + 1
st_coor_off_fault = st_coor_off_fault/1.e3
print(st_coor_off_fault)
#st_coor_off_fault = [ [-500,10,0],[-400,10,0],[-300,10,0],[-200,10,0],[-100,10,0], [-50,10,0], [0,10,0], \
#                      [500,10,0],[400,10,0],[300,10,0],[200,10,0],[100,10,0], [50,10,0], \
#                      [-500,20,0],[-400,20,0],[-300,20,0],[-200,20,0],[-100,20,0], [-50,20,0], [0,20,0], \
#                      [500,20,0],[400,20,0],[300,20,0],[200,20,0],[100,20,0], [50,20,0], \  ]
