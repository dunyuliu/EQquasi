...
par.insertFaultType = 1  # planar surface via generateFaultInterface
par.rough_fault = 1
...
# par.xi, minimum Dc
par.xi = 0.015 # par.xi used to limit variable time step size. See Lapusta et al. (2009).
