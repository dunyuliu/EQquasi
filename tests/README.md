...
```
python3 -m pytest tests/            # default: everything except e2e, ~4 s
...
python3 -m pytest -m e2e tests/     # builds and runs; ~20 min for BP8, longer with BP5/BP7
```
...
Oracles:
  ...
  - BP8 -- `reference/bp8/gold/summary.json`, frozen from v1.4.7.
