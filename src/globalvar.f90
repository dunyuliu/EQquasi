MODULE globalvar
	...
	integer (kind = 4) ::numnp, numel, neq, maxa, IERR, me, nprocs, np=1000000, status0, status1, it, itag, ivmax = 100, sol_op, nxt,nyt,nzt
	...
	integer (kind = 4) :: C_elastic, C_Nuclea, friclaw, rough_fault, bp, ntotft, nnx, nnz, nres, nplpts, nhplt=20, nstep=1000000, dis4uniF, dis4uniB, C_farfield = 0, icstart, stoptag
