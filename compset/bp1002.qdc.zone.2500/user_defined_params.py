#! /usr/bin/env python3
# compset: bp1002.qdc.zone.2500
# gate   : none -- UNVERIFIED (first read of a new experiment; no reference yet)
# changed: 2026-09-25
# note   : bp1002 with the VW patch held at FIXED AREA and fixed distance
#          from the step-over while the segment LENGTHS are made unequal
#          (A 57.5 km, B 102.5 km). PATHWAY_FORWARD row 7, owner decision
#          2026-09-24: "hold VW area fixed".
