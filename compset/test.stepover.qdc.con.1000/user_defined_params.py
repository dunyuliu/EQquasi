#! /usr/bin/env python3
# compset: test.stepover.qdc.con.1000
# gate   : e2e fast
...
par.far_vel_load = -4e-10  # LEFT-lateral: the one flip. Geometry identical to test.stepover.qdc.1000; left-lateral slip makes the same step compressional (constraining).
