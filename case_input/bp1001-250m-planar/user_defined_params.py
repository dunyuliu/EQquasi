...
exit_slip_rate = 1.0e-1 # exiting slip rate for EQquasi [m/s].

####################################
##### HPC resource allocation ######
####################################
casename = "bp1001test"
HPC_nnode = 2 # Number of computing nodes. On LS6, one node has 128 CPUs.
HPC_ncpu = 100 # Number of CPUs requested.
