...
# Reference files read by glob rather than by name. testsys/e2e/test_benchmarks.py
...
def _covered_by_glob(name):
    """True when testsys/e2e/test_benchmarks.py would find this file by pattern."""
...
def test_every_gold_file_is_named_somewhere_in_the_suite():
    ...
    assert not unreferenced, (
        ...
        "testsys/e2e/test_benchmarks.py, and are not among the families "
        "testsys/e2e/test_benchmarks.py discovers by glob -- either wire them "
